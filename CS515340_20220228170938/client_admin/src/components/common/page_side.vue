<template>
	<el-menu class="side el-menu-vertical-demo" default-active="/" @open="handleOpen" @close="handleClose"
		...
		<el-submenu index="user"
			...
			<el-menu-item index="/employee_user/table" v-show="user_group == '管理员' || $check_action('/employee_user/table')"><span>职员用户</span></el-menu-item>
			<el-menu-item index="/management_users/table" v-show="user_group == '管理员' || $check_action('/management_users/table')"><span>管理层用户</span></el-menu-item>
